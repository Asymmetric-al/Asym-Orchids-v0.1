...
import { FeedPost, NewPostDialog } from '@/components/feed'
import type { PostWithAuthor } from '@/types/database'

export default function MissionaryFeedPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="py-12 text-center text-muted-foreground">
          No posts yet. Create your first post to share with your supporters!
        </div>
      ) : (
