...
import { Users, Target, FileText, DollarSign, Bell, Send, TrendingUp, Calendar } from "lucide-react"

export default function MissionaryDashboard() {
  return (
    <div className="space-y-8 p-8">
      <div>
        <h2 className="text-3xl font-bold tracking-tight">Your Ministry Dashboard</h2>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center gap-4 p-3 rounded-lg bg-muted/50">
              <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-medium">MW</div>
              <div className="flex-1">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Latest updates on your support</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">New monthly supporter</p>
                <p className="text-sm text-muted-foreground">Thomas Smith started supporting at $150/month</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Prayer request received</p>
                <p className="text-sm text-muted-foreground">5 supporters prayed for your December update</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Update sent successfully</p>
                <p className="text-sm text-muted-foreground">Your December newsletter was delivered to 42 supporters</p>
